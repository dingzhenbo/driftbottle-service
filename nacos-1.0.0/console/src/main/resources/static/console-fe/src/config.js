...
module.exports = {
  ...
  'en-us': {
    ...
    disclaimer: {
      title: 'Vision',
      content:
        'By providing an easy-to-use provider infrastructure such as dynamic provider discovery, provider configuration, provider sharing and management and etc., Nacos help users better construct, deliver and manage their own provider platform, reuse and composite business provider faster and deliver value of business innovation more quickly so as to win market for users in the era of cloud native and in all cloud environments, such as private, mixed, or public clouds.',
    },
    documentation: {
      title: 'Documentation',
      list: [
