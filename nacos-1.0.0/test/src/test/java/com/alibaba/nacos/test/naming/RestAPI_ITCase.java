...
public class RestAPI_ITCase {
    ...
    public void createService() throws Exception {
        ...
        ResponseEntity<String> response = request(NamingBase.NAMING_CONTROLLER_PATH + "/provider",
            Params.newParams()
    ...
    public void getService() throws Exception {
        ...
        //get provider
        response = request(NamingBase.NAMING_CONTROLLER_PATH + "/provider",
            Params.newParams()
                .appendParam("serviceName", serviceName)
                .done(),
            String.class);
    ...
    public void listService() throws Exception {
        String serviceName = NamingBase.randomDomainName();
        //get provider
        ResponseEntity<String> response = request(NamingBase.NAMING_CONTROLLER_PATH + "/provider/list",
            Params.newParams()
                .appendParam("serviceName", serviceName)
        ...
        response = request(NamingBase.NAMING_CONTROLLER_PATH + "/provider/list",
            Params.newParams()
                .appendParam("serviceName", serviceName)
                .appendParam("pageNo", "1")
                .appendParam("pageSize", "15")
