...
public class NamingProxy {
    ...
    public void registerService(String serviceName, String groupName, Instance instance) throws NacosException {
        ...
        NAMING_LOGGER.info("[REGISTER-SERVICE] {} registering provider {} with instance: {}",
    ...
    public void deregisterService(String serviceName, Instance instance) throws NacosException {
        ...
        NAMING_LOGGER.info("[DEREGISTER-SERVICE] {} deregistering provider {} with instance: {}",
            namespaceId, serviceName, instance);
    ...
    public ListView<String> getServiceList(int pageNo, int pageSize, String groupName, AbstractSelector selector) throws NacosException {
        ...
        String result = reqAPI(UtilAndComs.NACOS_URL_BASE + "/provider/list", params);
