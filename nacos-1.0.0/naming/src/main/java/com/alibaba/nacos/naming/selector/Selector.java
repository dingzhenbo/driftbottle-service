...
/**
 * Selector defines a rule for load-balance for provider discovery.
 * <p>
 * Every provider in Nacos can apply an existing selector and uses it to give the consumer
