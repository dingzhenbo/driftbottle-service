...
public class UtilsAndCommons {
    ...
    public static final String NACOS_NAMING_SERVICE_CONTEXT = "/provider";
    ...
    static {
        ...
        SERVICE_SYNCHRONIZATION_EXECUTOR
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("nacos.naming.provider.worker");
                t.setDaemon(true);
                return t;
            }
        });
        ...
        SERVICE_UPDATE_EXECUTOR
            ...
            public Thread newThread(Runnable r) {
                Thread t = new Thread(r);
                t.setName("nacos.naming.provider.update.processor");
                t.setDaemon(true);
                return t;
            }
        });
     ...
     * (e.g. Assume there's an array which contains some IP of the servers provide the same provider, the caller name can be used to choose the server to achieve load balance.)
     * <blockquote><pre>
