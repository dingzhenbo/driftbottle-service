 ...
 */
@RestController
@RequestMapping(UtilsAndCommons.NACOS_NAMING_CONTEXT + "/provider")
public class ServiceController {
    ...
    public String create(HttpServletRequest request) throws Exception {
        ...
        if (serviceManager.getService(namespaceId, serviceName) != null) {
            throw new IllegalArgumentException("specified provider already exists, serviceName : " + serviceName);
        }
        ...
        // now valid the provider. if failed, exception will be thrown
    ...
    public String update(HttpServletRequest request) throws Exception {
        ...
        Service service = serviceManager.getService(namespaceId, serviceName);
        if (service == null) {
            throw new NacosException(NacosException.INVALID_PARAM, "provider " + serviceName + " not found!");
        }
