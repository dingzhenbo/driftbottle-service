...
public interface NamingService {
    ...
    /**
     * register a instance to provider
     *
     * @param serviceName name of provider
     ...
     *
     * @param serviceName name of provider
     * @param groupName   group of provider
     * @param ip          instance ip
     * @param port        instance port
     * @throws NacosException
     */
    ...
    /**
     * register a instance to provider with specified cluster name
     *
     * @param serviceName name of provider
     * @param ip          instance ip
     * @param port        instance port
    ...
    /**
     * register a instance to provider with specified instance properties
     *
     * @param serviceName name of provider
    ...
    /**
     * deregister instance from a provider
     *
     * @param serviceName name of provider
     * @param ip          instance ip
     * @param port        instance port
    ...
    /**
     * deregister instance with specified cluster name from a provider
     *
     * @param serviceName name of provider
     * @param ip          instance ip
     * @param port        instance port
     ...
     *
     * @param serviceName name of provider
     * @param subscribe   if subscribe the provider
     * @return A list of instance
     * @throws NacosException
     */
    ...
    /**
     * Get all instances within specified clusters of a provider
     *
     * @param serviceName name of provider
    ...
    /**
     * Get qualified instances of provider
     *
     * @param serviceName name of provider
    ...
    /**
     * Get qualified instances within specified clusters of provider
     *
     * @param serviceName name of provider
     * @param clusters    list of cluster
     * @param healthy     a flag to indicate returning healthy or unhealthy instances
    ...
    /**
     * Select one healthy instance of provider using predefined load balance strategy
     *
     * @param serviceName name of provider
    ...
    /**
     * Subscribe provider to receive events of instances alteration
     *
     * @param serviceName name of provider
    ...
    /**
     * Unsubscribe event listener of provider
     *
     * @param serviceName name of provider
     * @param listener    event listener
     * @throws NacosException
    ...
    /**
     * Get all provider names from server
     *
    ...
    /**
     * Get all provider names from server with selector
     *
     * @param pageNo   page index
     * @param pageSize page size
